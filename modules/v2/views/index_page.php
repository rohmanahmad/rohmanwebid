                ...
                <div class="col-sm-9">
					<form>
					  ...
					  <div class="form-group">
					    ...
					    <input name="filename" type="password" class="form-control" id="exampleInputPassword1" placeholder="Password">
					  </div>
					  <div class="form-group">
					  ...
					  <a href="<?=site_url('picasa_upload/galery')?>" class="btn btn-default">Lihat Galery</a>
					</form>
                </div>
            </div>
