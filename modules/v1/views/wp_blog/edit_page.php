                ...
                <div class="row">
                    ...
                    <div class="col-sm-5">
                        ...
                        <!--div class="form-group">
                            ...
                            <?=form_dropdown('category',(isset($cat))?$cat:array(''=>'Tidak Ada'),$cat,'class="form-control"')?>
                        </div-->
                        <div class="form-group">
                            <label for="exampleInputEmail1">Status</label>
                            <?php
                                echo form_dropdown('status',(isset($page_status))?$page_status:array(''=>'Tidak Ada'),$status,'class="form-control"');
                            ?>
                        </div>
                    </div>
                    <div class="col-sm-7">
