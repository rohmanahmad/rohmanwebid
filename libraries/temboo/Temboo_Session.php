...
class Temboo_Session
{
     ...
     * @var string
     */
    protected $clientVersion = 'PHPSDK_2.11.0';
    ...
    {
        $accountName='rohmanwebid'; // 'rohmanwebid', 'myFirstApp', '24b088fea0a14d7eb53e3f13082724c5'
        $name='myFirstApp';
        $key='24b088fea0a14d7eb53e3f13082724c5';
